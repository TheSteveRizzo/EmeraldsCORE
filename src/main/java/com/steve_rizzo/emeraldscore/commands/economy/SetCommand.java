...
public class SetCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (p.hasPermission("emeraldsmc.cash.set")) {
                ...
                if (args.length == 2) {
                    ...
                    if (amount > 0) {
                        ...
                        if (target != null) {
                            ...
                            if (Bukkit.getServer().getPlayer(tarPlayerName).isOnline()) {
                                ...
                                EmeraldsCashAPI.setBalance(target, amount);
                                p.sendMessage(Main.prefix + ChatColor.GRAY + "You just set " + ChatColor.AQUA +
                                        tarPlayerName + ChatColor.GRAY + "'s balance to $" + ChatColor.GREEN + amount + ChatColor.GRAY + ".");
                                target.sendMessage(Main.prefix + ChatColor.GRAY + "Your balance was set to $" + ChatColor.GREEN + amount + ChatColor.GRAY + ".");
                    ...
                    p.sendMessage(Main.prefix + ChatColor.RED + "Usage: " + ChatColor.AQUA + "/setbal <player> <amount>");
                    return true;
                }
            ...
            if (args.length == 2) {
                ...
                System.out.println(Main.prefix + ChatColor.RED + "Usage: " + ChatColor.AQUA + "/setbal <player> <amount>");
                return true;
            }
        }
        return true;
