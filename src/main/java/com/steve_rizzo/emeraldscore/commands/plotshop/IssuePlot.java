...
public class IssuePlot implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (hasEnoughFunds(uuid, 500000)) {

            EmeraldsCashAPI.deductFundsUUID(uuid, 500000);

            Bukkit.getServer().dispatchCommand(getServer().getConsoleSender(), "rg addowner -w \"EmeraldsKingdom\"" + " " + plotRegionID + " " + args[0]);
